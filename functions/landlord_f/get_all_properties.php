<?php
// functions/landlord_f/get_all_properties.php - Get ALL Available Properties (for tenant view)
...
try {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $properties[] = [
            ...
            'landlordName' => $row['landlord_name'] ?? 'Property Owner',
            'landlordContact' => $row['landlord_contact'] ?? null,
            'photos' => $photos,
